...
# Connect Wildcats database with local host SQL server
...
# find player team id by match the name in SQL server
    ...
    for i in dt1_name:
        if i in dt2_name:
            ...
            if dt1_row.equals(dt2_row):
                ...
                # separate the update data for query
